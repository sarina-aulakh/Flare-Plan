...
const styles = StyleSheet.create({
  ...
  heading: { fontSize: 30, fontWeight: '700', color: Colors.text, marginBottom: 4 },
  subheading: { fontSize: 16, color: Colors.accent, marginBottom: 32, lineHeight: 26 },
  ...
  link: { textAlign: 'center', fontSize: 14, color: Colors.accent },
  ...
  doneCheck: { fontSize: 40, fontWeight: '700', color: Colors.muted, marginBottom: 16 },
  doneHeading: { fontSize: 22, fontWeight: '700', color: Colors.text, marginBottom: 8 },
  doneSub: { fontSize: 16, color: Colors.accent, textAlign: 'center', marginBottom: 32, lineHeight: 26 },
})
