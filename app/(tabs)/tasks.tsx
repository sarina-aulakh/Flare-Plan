...
const styles = StyleSheet.create({
  ...
  dueDate: { fontSize: 13, color: Colors.accent, marginBottom: 14 },
  cardActions: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  tipButton: { paddingVertical: 8, paddingRight: 16 },
  tipButtonText: { fontSize: 13, color: Colors.accent, fontWeight: '500' },
  doneButton: {
  ...
  emptySub: { fontSize: 14, color: Colors.accent, textAlign: 'center' },
  ...
  energyHint: { fontSize: 12, color: Colors.accent, marginTop: -4 },
  formError: { color: '#F87171', fontSize: 13 },
  submitButton: {
    backgroundColor: Colors.text,
    borderRadius: 12,
    padding: 16,
