...
const styles = StyleSheet.create({
  ...
  sub: { fontSize: 14, color: Colors.accent, marginBottom: 36, lineHeight: 22 },
  question: { fontSize: 15, fontWeight: '500', color: Colors.secondary, marginBottom: 16 },
  ...
  nextButton: { backgroundColor: Colors.text, borderRadius: 14, padding: 17, alignItems: 'center' },
  ...
  energyLabel: { fontSize: 15, fontWeight: '600', color: Colors.text },
  energyDesc: { fontSize: 13, color: Colors.accent },
  ...
  emptySub: { fontSize: 14, color: Colors.accent },
  ...
  planMetaText: { fontSize: 12, color: Colors.accent },
  overflowNote: {
    backgroundColor: Colors.white, borderRadius: 12, padding: 14, marginBottom: 20,
    shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.04, shadowRadius: 2, elevation: 1,
  },
  overflowText: { fontSize: 13, color: Colors.accent, textAlign: 'center' },
